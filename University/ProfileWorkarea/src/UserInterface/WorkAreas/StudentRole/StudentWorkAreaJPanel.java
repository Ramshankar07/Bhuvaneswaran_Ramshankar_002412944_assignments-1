...
public class StudentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public StudentWorkAreaJPanel(Department b, StudentProfile spp, JPanel clp) {
...
// TODO add your handling code here:
        ...
        StudschJPanel aos = new StudschJPanel(business, CardSequencePanel,student);

        CardSequencePanel.add("StudschJPanel", aos);
...
*/
    ...
    private void BtnregistrationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnregistrationActionPerformed
        ...
        StudRegJPanel aos = new StudRegJPanel(business, CardSequencePanel,student);

        CardSequencePanel.add("StudRegJPane", aos);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
